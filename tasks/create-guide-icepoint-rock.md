# Create TurtleGuide: Icepoint Rock (40-50) - Contested Zone

## Task
Create a leveling guide for **Icepoint Rock**, a contested zone in Turtle WoW (levels 40-50).
...
1. **Research the zone online:**
   - Search for "Turtle WoW Icepoint Rock quests"
...
3. **Create guide file(s):**
   - `Guides/Alliance/40_50_Icepoint_Rock.lua` and/or `Guides/Horde/40_50_Icepoint_Rock.lua`
...
```lua
TurtleGuide:RegisterGuide("Icepoint Rock (40-50)", "Next Zone (Level)", "Alliance",function()
return [[

N Welcome to Icepoint Rock |N|Zone introduction.|

f Zone Hub |N|Get flight point (X, Y)| |Z|Icepoint Rock|
h Zone Hub |N|Set hearthstone| |Z|Icepoint Rock|

A Quest Name |QID|XXXXX| |N|NPC Name (X, Y)| |Z|Icepoint Rock|
C Quest Name |QID|XXXXX| |N|Objectives (X, Y)| |Z|Icepoint Rock|
T Quest Name |QID|XXXXX| |N|NPC Name (X, Y)| |Z|Icepoint Rock|
