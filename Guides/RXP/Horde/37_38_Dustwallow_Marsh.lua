...
A An Unholy Alliance |QID|6521| |N|Have somebody in your group share the following quests if possible. Alternatively, go to Undercity to pick them up yourself (RFD Dungeon Quest)| |D|RFD| |Z|The Barrens|
A Bring the End |QID|3341| |N|Have somebody in your group share the following quest if possible. Alternatively, go to Undercity to pick it up yourself (RFD Dungeon Quest)| |D|RFD| |Z|The Barrens|
...
B Stock up on [Flash Powder] and [Poisons] |N|Rekkul - (42.1, 49.5) (RFD Dungeon Quest)| |C|Rogue| |D|RFD| |Z|Orgrimmar|
