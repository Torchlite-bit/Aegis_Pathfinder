-- Converted from RestedXP format: 21-23 Ashenvale/Stonetalon
AegisPathfinder:RegisterGuide("RXP/21-23 Ashenvale/Stonetalon", "RXP/23-24 Wetlands", "Alliance", function()
return [[

N 21-23 Ashenvale/Stonetalon |N|Converted from RestedXP guide|
...
B Restock on Ammo, make sure you have at least 10-15 stacks as the next section is a grindy and there won't be any ammo vendor to restock |N|Haljan Oakheart - (34.8, 50.8)| |C|Hunter| |Z|Ashenvale|
C Collect Gooey Spider Leg (x6) |QID|93| |L|2251 6| |N|Save up to 6 Gooey Spider Legs looted from the Spiders in the zone. You will need them for a quest later| |O| |Z|Ashenvale|
