-- ==========================================================
-- AegisPathfinder Format Converter
-- Converts between AegisPathfinder string format and QuestShell+ Lua table format
...
-- ==========================================================
-- AegisPathfinder -> QuestShell+ Conversion
-- ==========================================================
...
-- Parse a single AegisPathfinder line into QuestShell+ format
...
-- Convert entire AegisPathfinder guide string to QuestShell+ format
...
-- ==========================================================
-- QuestShell+ -> AegisPathfinder Conversion
-- ==========================================================

-- Format coordinates for AegisPathfinder
...
-- Convert a single QuestShell+ step to AegisPathfinder line
...
-- Convert entire QuestShell+ guide to AegisPathfinder format
...
function FormatConverter.guideToLuaFile(guide, varName)
    ...
    local lines = {
        ...
        "-- Generated by AegisPathfinder Format Converter",
        "-- =========================",
        "",
        varName .. " = " .. varName .. " or {}",
        "",
...
-- Read a AegisPathfinder file and convert to QuestShell+ Lua file
function FormatConverter.convertFile(inputPath, outputPath, metadata)
    ...
    -- Extract the guide string from AegisPathfinder format
    -- AegisPathfinder wraps guides in: AegisPathfinder:RegisterGuide("name", "faction", function() return [[...]] end)
