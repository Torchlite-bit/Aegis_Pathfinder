...
| Profession routes (`Guides/Professions/`) | Converted from a reference document supplied by the repository owner; see [LICENSE-STATUS.md](LICENSE-STATUS.md) |
...
Several projects in the lineage above carry no licence, which is why this
addon is not yet distributable. That is a question of permission, not of
credit — the credit above stands regardless. See
